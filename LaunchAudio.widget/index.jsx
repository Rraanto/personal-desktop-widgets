...
const options = {
  ...
  horizontalPosition: "75",   // -> left (default) | center | right | "<number>" | "-<number>"
...
export const className = `
  ...
  bottom: 0;
  right: 0;
  font-family: "Menlo", BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol";
  color: white;
