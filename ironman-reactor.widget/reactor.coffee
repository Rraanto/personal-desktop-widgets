...
.core {
  ...
  border-radius: 50%;
  border: 10px rgba(2, 200, 255, 0.15) solid;
...
.semi_arc:hover {
  box-shadow: 0px 0px 30px rgba(2, 200, 255, 0.8);
  transition: 0.3s;
}
...
.e1:after {
  border-color: rgba(2, 200, 255, 0.6);
...
.e4_1 {
  border-color: rgba(2, 200, 255, 0.3);
  border-left: 5px solid transparent;
  border-right: 5px solid transparent;
}
